...
const Admission = () => {
  ...
  const applicationSteps = [
    {
      ...
      description: "Rassemblez les documents nécessaires pour constituer un dossier complet et compétitif.",
      icon: FileText,
      color: "blue",
      details: [
    ...
    },
    {
      ...
      description: "Complétez votre candidature sur notre plateforme dédiée du 11 août au 7 septembre 2025.",
      icon: Upload,
      color: "emerald",
      details: [
    ...
    },
    {
      ...
      description: "Notre commission pédagogique examine chaque dossier avec attention et expertise.",
      icon: Search,
      color: "violet",
      details: [
    ...
    },
    {
      ...
      description: "Rencontre avec notre jury pour évaluer votre motivation et votre potentiel.",
      icon: Users,
      color: "orange",
      details: [
  ...
  const selectionCriteria = [
    { percentage: 50, label: "Dossier académique", icon: FileCheck, color: "blue" },
    { percentage: 30, label: "Entretien de motivation", icon: Users, color: "emerald" },
    { percentage: 15, label: "Expérience professionnelle", icon: Briefcase, color: "violet" },
    { percentage: 5, label: "Projets personnels", icon: Lightbulb, color: "orange" }
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <div className="text-gray-600 max-w-6xl mx-auto space-y-4 leading-relaxed">
            <p>
              Rejoignez le <strong className="text-blue-600">Master Systèmes Intelligents pour l'Éducation</strong> et devenez un acteur 
              de la transformation numérique dans le secteur éducatif.
            </p>
          </div>
        </div>
        ...
        <section className="mb-16">
          {/* <div className="text-center mb-8">
            <div className="relative flex flex-col items-center justify-center text-center mb-6 px-4 sm:px-6 md:px-8">
              ...
              <h2 className="text-xl sm:text-xl md:text-2xl lg:text-3xl font-bold flex flex-wrap items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent leading-snug">
                <GraduationCap className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-blue-500 flex-shrink-0" />
                Diplômes <span className="text-gray-800">Requis</span>
              </h2>

              <div className="mt-3 h-1 w-36 sm:w-36 md:w-48 lg:w-56 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"></div>
            </div>
            <p className="text-gray-600 max-w-3xl mx-auto text-sm">
              Le master est accessible aux titulaires de licences dans les domaines suivants
            </p>
          </div> */}
          ...
          <div className="p-6">
                    ...
                    <div className="relative mb-3">
                      <div className="w-20 h-20 mx-auto rounded-full flex items-center justify-center border-2 border-gray-200">
                        <div className="text-center">
                          ...
                          <IconComponent className={`h-5 w-5 ${colorClasses.icon} mx-auto`} />
                        </div>
                      </div>
                    </div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-bold text-blue-800 text-sm mb-2">Conseils pour votre candidature</h4>
                  <ul className="text-blue-700 space-y-1 text-xs">
                    <li>• Mettez en avant vos projets personnels et votre motivation pour l'IA éducative</li>
                    <li>• Préparez soigneusement votre lettre de motivation et votre CV</li>
                    <li>• Choisissez des recommandants qui connaissent bien votre travail académique</li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start space-x-4 mb-4">
                    <div className={`flex-shrink-0 w-10 h-10 rounded-lg ${colorClasses.bg} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                      <IconComponent className={`h-5 w-5 ${colorClasses.icon}`} />
                    </div>
                    <div>
                      <div className={`inline-flex items-center justify-center w-auto py-1 px-4 rounded-md ${colorClasses.bg} text-xs font-bold ${colorClasses.text} mb-2`}>
                        {step.title}
                      </div>
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-bold text-gray-800 text-sm mb-1">{date.title}</h4>
                        <p className="text-blue-600 font-semibold text-sm mb-1">{date.date}</p>
                        <p className="text-gray-600 text-xs">{date.description}</p>
                      </div>
                    </div>
                  </div>
                );
          ...
          <div className="p-8">
            ...
            <div className="text-center">
              <p className="text-blue-100 mb-6 text-sm leading-relaxed max-w-2xl mx-auto">
                Postulez dès maintenant pour la promotion 2025/2026 et devenez un expert 
                en systèmes intelligents pour l'éducation.
              </p>
        ...
        <div className="text-center">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              Notre équipe est disponible pour répondre à toutes vos questions sur le processus d'admission.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4 text-xs">
              <div className="flex items-center justify-center text-gray-600">
                <Mail className="h-4 w-4 mr-2" />
                admission-master@ens-meknes.ac.ma
              </div>
              <div className="flex items-center justify-center text-gray-600">
